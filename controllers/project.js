...
var controller ={
	...
	saveProject: function(req, res){
		...
		project.save((err,projectStored) => {
			...
			if(!projectStored) return res.status(404).send({messsage:'No se ha podido guardar el proyecto'});
	...
	deleteProject: function(req, res){
		...
		Project.findByIdAndRemove(projectId, (err,projectRemoved) =>{
			...
			if(!projectRemoved) return res.status(404).send({message: 'No se ha podido eliminar este proyecto'});
			return res.status(200).send({
